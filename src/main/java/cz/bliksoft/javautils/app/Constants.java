...
public class Constants {
	...
	// public static final String WORKPLACE_ID_KEY = "workplaceIdentification";
	// //$NON-NLS-1$
	//
	...
	// // FIXME lokalizace!!
	// public static final String FULL_DATE_PATTERN =
	// "^(?<day>[0123]?\\d)[\\.\\,\\-\\/](?<month>[01]?\\d)[\\.\\,\\-\\/](?<year>[0-9]{2}|[12][0-9]{3})?$";
	// public static final String EDIT_DATE_PATTERN =
	// "^(?<day>[0123]\\d{1})(?<month>[01]\\d)(?<year>[0-9]{2}|[12][0-9]{3})?$";
	// public static final String EDIT_DATE_RELATIVE =
	// "^(?<direction>[\\+\\-])(?<count>\\d*)(?<step>[dtmrDMTR])?$";
	// public static final String EDIT_DATE_DAY_RELATIVE =
	// "^(?<direction>[\\+\\-])(?<count>\\d*)(?<day>(PO)|(UT)|(ST)|(CT)|(PA)|(SO)|(NE)|(po)|(ut)|(st)|(ct)|(pa)|(so)|(ne))?$";
	// public static final String NID_PATTERN =
	// "^(?<PART1>(?<YEAR>\\d{2})(?<MONTH>\\d{2})(?<DAY>\\d{2}))([\\/])?(?<PART2>\\d{3,4})$";
	//
	// /**
	...
	// public static final Marker LOG_MARKER_ENTITY =
	// MarkerManager.getMarker("ENTITY");
